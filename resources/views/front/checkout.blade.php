                                            ...
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <select name="addr[billing][country]" class="form-select">
                                                        ...
                                                        <option value="{{ $value }}" {{ old('addr.billing.country') == $value ? 'selected' : '' }}>
                                                            {{ $label }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-input form">
                                                        <x-form.input name="addr[shopping][first_name]" placeholder="First Name" />

                                                    </div>
                                                    <div class="col-md-6 form-input form">
                                                        <x-form.input name="addr[shopping][last_name]" placeholder="Last Name" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Email Address</label>
                                                <div class="form-input form">
                                                    <x-form.input name="addr[shopping][email]" placeholder="Email Address" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Phone Number</label>
                                                <div class="form-input form">
                                                    <x-form.input name="addr[shopping][phone_number]" placeholder="Phone Number" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <label>Mailing Address</label>
                                                <div class="form-input form">
                                                    <x-form.input name="addr[shopping][street_address]" placeholder="Mailing Address" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>City</label>
                                                <div class="form-input form">
                                                    <x-form.input name="addr[shopping][city]" placeholder="City" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Post Code</label>
                                                <div class="form-input form">
                                                    <x-form.input name="addr[shopping][postal_code]" placeholder="Post Code" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Country</label>
                                                <div class="form-input form">
                                                    <select name="addr[shopping][country]" class="form-select">
                                                        @foreach($countries as $value => $label)
                                                        <option value="{{ $value }}" {{ old('addr.shopping.country') == $value ? 'selected' : '' }}>
                                                            {{ $label }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                    @error('addr.shopping.country')
                                                    <div class="text-red-600 text-sm">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Region/State</label>
                                                <div class="select-items">
                                                    <x-form.input name="addr[shopping][state]" placeholder="State" />
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4">
                    <div class="checkout-sidebar">
                        ...
                        <div class="checkout-sidebar-discount">
